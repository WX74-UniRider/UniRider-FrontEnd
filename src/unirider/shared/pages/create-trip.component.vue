<template>
  <div class="flex justify-center items-center min-h-screen bg-blue-100">
    ...
    <div class="w-full max-w-2xl bg-white p-6 rounded-lg shadow-lg">
      ...
      <!-- Viajes Anteriores -->
      <div class="mt-6">
        <h2 class="text-lg font-semibold text-teal-700 mb-4 text-center">Viajes Anteriores</h2>
        <ul class="space-y-3">
          <li
              v-for="(trip, index) in previousTrips"
              :key="index"
              @click="selectPreviousTrip(trip)"
    ...
    >
      <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
        <h2 class="text-xl font-semibold text-center text-teal-700 mb-4">¡Viaje Creado!</h2>
        <p class="text-gray-600 text-center mb-6">
          Tu viaje ha sido creado exitosamente.
        </p>
        <button
            @click="redirectToHome"
            class="w-full bg-gradient-to-r from-teal-400 to-teal-600 hover:from-teal-500 hover:to-teal-700 text-white py-2 rounded-lg text-base font-semibold shadow-md hover:shadow-lg transform transition-transform duration-300 ease-in-out hover:scale-105">
          Ir al Home
        </button>
      </div>
    </div>
...
// Lista de viajes ficticios
const previousTrips = ref([
  {
    tripName: "Viaje al Centro",
    tripDate: "2024-11-20",
    tripTime: "14:00",
    destination: "Centro de Lima",
  },
  {
    tripName: "Viaje a Miraflores",
    tripDate: "2024-11-19",
    tripTime: "09:00",
    destination: "Miraflores",
  },
  {
    tripName: "Viaje a San Isidro",
    tripDate: "2024-11-18",
    tripTime: "16:30",
...
// Función para seleccionar un viaje anterior
const selectPreviousTrip = (trip) => {
